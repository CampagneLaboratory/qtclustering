...
/**
 * Maximum distance linkage calculator. Calculate the distance of a point to a cluster as the maximum
 * distance between the point and each point of the cluster.
 *
...
public abstract class MaxLinkageDistanceCalculator implements SimilarityDistanceCalculator {
    public abstract double distance(final int instanceIndex, final int otherInstanceIndex);
